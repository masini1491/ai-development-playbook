# Gemini CLI bootstrap compatibility

This file is a thin repository bootstrap shim for Gemini CLI. It is not a Playbook authority and does not create a second current-state policy source.
