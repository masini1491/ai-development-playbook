...
| Repository information architecture / durable project memory | `AI_CONTEXT.md` → `AI Context Surface Model`、`AI Readability / Retrieval Cost Change Gate` | Always-on／Hot／Cold／Evidence／Current canonical／Historical、retrieval cost、Context Cohesion、session-local verified reuse／selective invalidation、hot-path growth ratchet。 |
