...
| GitHub operational routing / verified transport / Actions / Release | `GITHUB_OPERATIONS.md` → `GitHub Operation Routing`、`Inbound Verified Transport`、`Outbound Repository Mutation`、`Remote Deterministic Execution`、`Tag / Release Publication` | **GitHub-specific operational owner**：把已授權的 GitHub acquisition／transport／mutation／remote execution／publication轉成可驗證 recipes；authority與 validation semantics仍由既有 owners 決定。 |
